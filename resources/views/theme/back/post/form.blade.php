<div class="form-group row">
    ...
    <div class="col-sm-8">
        <input type="text" name="titulo" id="titulo" class="form-control"
            value="{{ old('titulo', $post->titulo ?? '') }}" maxlength="150" required>
    </div>
</div>
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <input type="text" name="slug" id="slug" class="form-control"
            value="{{ old('slug', $post->slug ?? '') }}" maxlength="150" required>
    </div>
</div>
@php
    $categoriaP = [];
    ...
    if (isset($post)) {
        ...
        $imagen = asset("storage/{$archivo->ruta}") ?? 'https://placehold.co/200x150?text=Imagen+Post';
    } else {
        $imagen = 'https://placehold.co/200x150?text=Imagen+Post';
    }
@endphp
<div class="form-group row">
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <select name="tag[]" id="tag" class="select2" multiple="multiple" style="width: 100%;">
...
<div class="form-group row">
    ...
    <div class="col-sm-5">
        <input type="file" name="imagen" id="imagen"
            data-initial-preview="{{ $imagen }}" accept="image/*">
    </div>
</div>
